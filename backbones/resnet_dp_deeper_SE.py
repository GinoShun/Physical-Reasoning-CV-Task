...
class CNN(nn.Module):
    def __init__(self, n_classes=6):  # Add n_classes as a parameter
        ...
        self.layer1 = self._make_layer(64, 128, stride=2, use_standard=True)  # Reduce spatial dimensions
    ...
    def _make_layer(self, in_channels, out_channels, stride, use_standard=False):
        if use_standard:
